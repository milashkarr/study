...
set arr[6].file=run_test_doubly_linked_list.bat
set arr[7].file=run_test_vector.bat
...
set arr[6].folder=scl\test\doubly_linked_list
set arr[7].folder=scl\test\vector
